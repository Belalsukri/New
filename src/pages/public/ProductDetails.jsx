        ...
        <div style={{ paddingBottom: '6rem', background: '#f8fafc', minHeight: '100vh', direction: 'rtl' }}>
            ...
            <div className="container" style={{ padding: '1.5rem 1rem', maxWidth: '1000px', margin: '0 auto' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 350px), 1fr))', gap: '2rem', alignItems: 'start' }}>
                    ...
                    <div style={{ background: 'white', position: 'relative', width: '100%', aspectRatio: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
